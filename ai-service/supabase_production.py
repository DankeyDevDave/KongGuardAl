...
EOF"""
    ...
    def create_attack_run(
        self, intensity: str, strategy: str, duration: int = 60, config: dict = None
    ) -> Optional[int]:
...
def main():
    ...
    run_id = supabase.create_attack_run(intensity="high", strategy="production_demo", duration=300)
