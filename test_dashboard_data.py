...
async def test_dashboard_data():
    ...
    test_cases = [
        {
            ...
            "payload": {
                ...
                "context": {"previous_requests": 15, "failed_attempts": 8, "anomaly_score": 0.9},
            },
        },
        {
            ...
            "payload": {
                ...
                "context": {"previous_requests": 5, "failed_attempts": 1, "anomaly_score": 0.6},
            },
        },
        {
            ...
            "payload": {
                ...
                "context": {"previous_requests": 25, "failed_attempts": 0, "anomaly_score": 0.1},
            },
        },
    ]
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        for i, test_case in enumerate(test_cases, 1):
            ...
            try:
                response = await client.post("http://localhost:18002/analyze", json=test_case["payload"])
                ...
                if response.status_code == 200:
                    ...
                    missing_fields = [
                        field for field in required_fields if field not in result or result[field] is None
                    ]
