...
class EnterpriseAttackPresentation:
    ...
    async def send_attack_with_narrative(self, attack_data: Dict[str, Any], narrative: str) -> Dict[str, Any]:
        ...
        # Display narrative
        console.print(Panel(
            Text(narrative, style="bold cyan"),
            title="[red]🎯 ENTERPRISE THREAT SCENARIO[/red]",
            border_style="red"
        ))
        ...
        attack_table.add_row("Payload Preview", str(attack_data['features'].get('query', '') + 
                            attack_data['features'].get('body', ''))[:100] + "...")
    ...
    def display_threat_analysis(self, result: Dict[str, Any], processing_time: float):
        ...
        console.print(Panel(
            results_text,
            title="[green]🛡️ KONG GUARD AI ANALYSIS COMPLETE[/green]",
            border_style="green"
        ))
    ...
    async def present_final_summary(self):
        ...
        summary_table.add_row(
            ...
            str(self.presentation_stats["attacks_launched"]),
            "Real enterprise threats"
        )
        summary_table.add_row(
        ...
        summary_table.add_row(
            ...
            str(self.presentation_stats["critical_blocks"]),
        ...
        # Final message
        console.print(Panel(
            Text("🛡️ KONG GUARD AI: YOUR ENTERPRISE SECURITY SHIELD\n\n"
